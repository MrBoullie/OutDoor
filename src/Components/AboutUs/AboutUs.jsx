        ...
        <div className="align-items-center justify-content-center gap-5 mx-auto row col-12 mt-5 flex-wrap mx-lg-0">
          ...
          >
            ...
            <ul className="list-unstyled" style={{ color: "#777" }}>
              ...
              <li>
                <i className="fas fa-star"></i> Rated #1 in customer
                satisfaction
              </li>
            </ul>
          </div>
          ...
          >
            ...
            <p
              className="mb-4 fs-5 fw-medium text-center"
              style={{ minHeight: "125px" }}
            >
              We are a group of outdoor enthusiasts, innovators, and dreamers
              committed to bringing you top-quality gear and exceptional
              service.
            </p>
            <ul className="list-unstyled" style={{ color: "#777" }}>
              <li>
              ...
              <li>
                <strong>Sajed Wazneh:</strong> Operations Expert and
                Problem-Solver
              </li>
              <li>
